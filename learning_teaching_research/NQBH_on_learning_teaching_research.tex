...
\usepackage{amsmath,amssymb,amsthm,enumitem,fancyvrb,float,fourier-orns,glossaries,graphicx,mathtools,minitoc,multicol,musicography,soul,subfig,tikz,tipa}
...
\begin{center}
	\thispagestyle{empty}
	\vspace*{\fill}\it
	Dedicated to disadvantaged kids who love to learn about this world, love to discover this wonderful life, children \& young adults who are sensitive, \& vulnerable children in broken families.\\\vspace{2cm}
	Gửi tặng những đứa trẻ có hoàn cảnh khó khăn nhưng thích học về thế giới này, thích khám phá cuộc sống kỳ diệu này, những đứa trẻ \& người trẻ nhạy cảm cao, dễ tổn thương trong các gia đình tan vỡ.
	\vspace*{\fill}
\end{center}
\clearpage
\tableofcontents
...
\begin{itemize}
    \item NQBH, NQTN. {\it Some Thoughts on Learning, Teaching, \& Research: A Short Novel -- Vài Suy Nghĩ Về Việc Học, Việc Dạy, \& Nghề Nghiên Cứu: 1 Tiểu Thuyết Ngắn}.
    
    PDF: {\sc url}: \url{https://github.com/NQBH/advanced_STEM_beyond/blob/main/learning_teaching_research/NQBH_on_learning_teaching_research.pdf}.
    
    \TeX: {\sc url}: \url{https://github.com/NQBH/advanced_STEM_beyond/blob/main/learning_teaching_research/NQBH_on_learning_teaching_research.tex}.    
\end{itemize}
...
\begin{quote}
   {\it How long is it?} {\it How long about what?} To be able to come to this path, to become this version, this unification -- the balancing combination of all pieces that we have been trying to split.    
\end{quote}
...
\begin{note}
    Tôi không phải là 1 đứa sáng dạ về mặt ngôn ngữ cho lắm, cho dù là bản thể nào đi chăng nữa.
\end{note}
...
Nah, these things so difficult. I get back to my mathematics, my calculations, my mathematics. Wait a sec. Do these dry \& hard computations without wet \& soft insights really make me happy? I doubt it. I also doubt all of other questions.
...
\begin{quote}
    ...
    Đến đây thì cần đến sự xuất hiện của 1 nhân vật mới, thật ra là cũ, {\sf {\sf Tr} [25; 1st-year mathematical PhD student in Austria]} -- 1 con chuột thành thị chính hiệu: a real town mouse. Kiểu học thức, sinh ra từ gia đình cha{\tt/}mẹ giáo viên, giỏi Toán \& nhiều môn khác, thủ khoa các kiểu, mọi thứ đều phải hoàn hảo tươm tất, chủ nghĩa cầu toàn? (perfectionism?), có sức hấp dẫn với những người thèm kiểu người đầy hiểu biết, nhưng chỉ tiếc là hắn sống với đầy định kiến về người khác. 1 con chuột phố như {\sf Tr} không thể nào chấp nhận 1 con chuột quê như {\sf Hồng [25; 2nd-year mathematical PhD student in Germany]} có thể đi xa hơn hay leo cao hơn. Nếu {\sf Tr} có 1 cái bảng đo thực lực của người khác hoặc cái kiếng đo chỉ số sức mạnh trong phim Dragon Balls (nên dịch ra là 7 Viên Ngọc Rồng chứ không phải bi rồng) thì ai mà vượt quá cái bảng chỉ số định kiến đó là sẽ có chuyện, e.g., tìm cách đạp các con chuột quê hôi hám, bẩn thỉu, hạ đẳng đó xuống, hoặc ít nhất là cút ra khỏi lãnh địa thiêng liêng của Toán học. {\sf Tr} sẽ kiếm đến tận chỗ ở để ``giao lưu'', ``tìm hiểu'', săm soi khuyết điểm, \& quan trọng hơn là sẽ có những chiến thuật để thả những con rắn cái lai mèo $=$ linh miêu\footnote{``Về mặt văn hóa, linh miêu dùng để chỉ một sinh vật thần bí trong văn hóa tâm linh: Theo truyền thuyết dân gian, linh miêu là một loại mèo ma, được sinh ra từ cuộc hôn phối rừng rú ngẫu nhiên, hiếm có giữa con mèo cái đen tuyền với một con rắn hổ chỉ ăn duy nhất thịt cóc.'' -- \href{https://vi.wikipedia.org/wiki/Linh_mieu}{Wikipedia{\tt/}linh miêu}. Thus, we have a Biological Equation (abbr., BioEqn) -- Cho nên chúng ta có 1 Phương Trình Sinh Học (abbr., PTSH) theo nghĩa văn hóa tâm linh ở đây:
        \begin{center}
            {\sf PTSH{\tt/}BioEqn}: Con Mèo Cái Đen Tuyền $+$ Con Rắn Hổ Chỉ Ăn Duy Nhất Thịt Cóc $\to$ Linh Miêu
        \end{center}
        Khá thú vị khi có 1 phương trình sinh học mang hơi hướm Spirtiuality -- Tâm Linh ở đây, bên cạnh các Phương Trình Toán Học (Mathematical Equations), Phương Trình Hóa Học (Chemical Reaction Equation), Phương Trình Vật Lý (Physical Equations). Chúng góp phần vào 1 thực thể mang tên ``Phương Trình' `Equation' trong địa hạt Khoa Học Tự Nhiên (Natural Science). Liệu địa hạt Khoa Học Xã Hội (Social Science) có tồn tại các Phương Trình Tâm Lý, Phương Trình Triết Học, Phương Trình Thần Học, hay thậm chí là 1 Phương Trình Tâm Linh siêu dị nằm ngoài trí tưởng tượng của đa số con người bình thường không? Có lẽ đấy chính là lúc ta cần sự trợ giúp của những gã tâm thần thiên tài.}, độc hại như nhân vật {\sf Trinh [26{\tt/}27?; Amazon junior software developer; covert aggressive narcissist, demanding taker, stalker]} để cắn Hồng, làm {\sf Hồng} phát suy \& trở nên yếu đi để dễ dàng thao túng \& kiểm soát. 1 định kiến sâu sắc mà những con chuột quê như {\sf Hồng [25; 2nd-year mathematical PhD student]} không bao giờ hiểu tại sao mình có cố gắng sống tốt \& làm bạn với chuột thành thị đều bất thành.
    
    Trong khi {\sf Hồng} có thể chơi đùa \& ăn uống thoải mái với các bạn người Brazil (nổi tiếng ăn cắp vặt), \& các bạn châu Phi (nổi tiếng ở bẩn \& mùi hôi tự nhiên của cơ thể) lúc còn ở Pháp, hay dân Maroc lúc còn ở Đức, thì ngược lại, {\sf Tr} dứt khoát nói không với dân da đen. Sự cách biệt giữa chuột quê \& chuột phố sâu sắc tới mức thấm sâu vào từng ngóc ngách của thói quen, cách nhìn, cách sinh hoạt, cách chọn người để giao thiệp, nói chung là cách thức 1 cá thể tương tác 1 cách chọn lọc với 1 số người cũng như cách thức cá thể đó tham gia vào các hoạt động xã hội rộng lớn hơn.
    
    {\sf Tr} không bao giờ cho Trinh chơi với nhóm bạn riêng của {\sf Tr} vì sợ Trinh làm dơ bất cứ ai trong cái nhóm đó, nhưng sẵn lòng thí {\sf Hồng} cho Trinh. Đấy là mấu chốt về cái ``tình bạn'' mà {\sf Hồng} luôn ảo tưởng, luôn mơ mộng về việc tìm 1 người cộng tác lâu dài -- a real collaborator \& a true friend -- trên con đường nghiên cứu Toán học. This is not Friendship. This is not Collaboration. This is $\Psi$-Manipulation. This is Destruction. {\it Nhưng {\sf Hồng} đã làm gì sai cơ chứ?} Có lẽ việc bị (?) sinh ra từ 1 gia đình nông dân nghèo kiết xác là cái tội lỗi lớn nhất không thể cứu vãn mà hắn sẽ mang theo suốt cuộc đời này để chịu sự trù dập, sự dày vò, các thủ đoạn hãm hại không thương tiếc của những con người đầy định kiến tương tự. {\it Maybe poverty is a real sin in this scenario}.
    
    Hồng thì lúc nào cũng giúp Trinh. Nhưng Trinh thì  coi việc được giúp như lẽ hiển nhiên. Kẻ yếu phải phục vụ kẻ mạnh, cho kẻ mạnh chà đạp lên. Trinh lúc nào cũng khinh Hồng. Trinh thèm chơi với {\sf Tr}. Người giỏi chơi với người giỏi. Con giáo viên chỉ chơi với con giáo viên hoặc tầng lớp cao hơn hoặc ngang bằng: only $\ge$ or better $\gg$, not $<$ or worse $\ll$ ({\it Worse is Better?}\footnote{See, e.g., \href{https://en.wikipedia.org/wiki/Worse_is_better}{Wikipedia{\tt/}worse is better}.} Not a single chance!), không thèm chơi với con nông dân. Được lợi dụng, dẫm đạp là phúc phần rồi nên phải tự biết thân biết phận mà cảm thấy may mắn \& hạnh phúc đi đồ hạ đẳng. Gió tầng nào gặp mây tầng đó. Cũng 1 cái bảng định kiến tương tự sinh ra từ cái cuộc thi Học Sinh Giỏi Quốc Gia THPT như trong quyển \cite{Long_truong_chuyen}: {\it Học Trường Chuyên -- Những Góc Nhìn Đa Chiều} -- Bảng Phong Thần: chia tách súc sanh, thường dân, \& thánh nhân. Toàn dạng á khoa, thủ khoa. {\sf Hồng} thì chả bao giờ ham mấy chuyện đó, nhưng hắn thừa biết là nước ngoài họ đòi hỏi ở mức độ rất khác mà thủ khoa Việt Nam chưa chắc ăn thua gì: Đấy là 1 mức độ ám ảnh về ham muốn am hiểu sâu sắc của tri thức. \& đây là nước Đức.
    
    {\sf Hồng} lại thêm 1 lần nữa thất vọng trong việc giúp đỡ người khác. Hắn vẫn chưa tởn. Nhìn cái mối quan hệ {\sf Tr}--{\sf Trinh} đầy phức tạp\footnote{Thêm nhân vật {\sf Trung [21; mathematical major student; valedictorian]} ăn cắp sách nữa: {\it Cái quái gì đang xảy ra với mấy đứa tên chữ `Tr' lứa sinh năm 1995--1996 thế hả {\sc Malcom Gladwell}?}}, {\sf Hồng} chợt nhớ tới chị {\sf Phương [26; 2nd-year mathematics PhD student in algebraic]} hồi ở Pháp. {\sf Hồng} giúp {\sf Phương} thì {\sf Phương} thù, {\sf Phương} ghét, {\sf Phương} khinh, {\sf Phương} đạp. {\sf Thọ [26; 3rd-year mathematics PhD student in mathematical physics]} hại {\sf Phương}, thao túng tâm lý {\sf Phương} thì {\sf Phương} thờ, {\sf Phương} phụng. {\sf Trinh} cũng thế. Chả đâu vào đâu. Những cái thiên kiến, định kiến mệt mỏi của cuộc đời khiến {\sf Hồng} chả muốn tiếp tục làm người tốt. Nhưng cái lõi của {\sf Hồng} là người tốt, hoặc ít nhất mẹ hắn nắn hắn thế. Thành ra {\sf Hồng} mệt mỏi trong chuyện làm người, sống như 1 con người đúng nghĩa. Lòng tốt thì bị khinh. Còn bị, à nhầm, được thao túng tâm lý thì phê lắm, sướng lắm, như kiểu máu M, cứ sáp vô kẻ hãm hại hoặc kẻ thao túng như hiệu ứng Stockholm (Stockholm syndrome, see, e.g., \href{https://en.wikipedia.org/wiki/Stockholm_syndrome}{Wikipedia{\tt/}Stockholm syndrome}) khi mà con tin bị bắt cóc dần yêu kẻ bắt cóc \& không thể tách rời được. Tâm lý con người quả là 1 mớ hỗ lốn đầy khó hiểu, muốn hiểu thì lại nhức đầu, rồi chả đâu vào đâu, ấy vậy mà 1 phần nhân cách của con chuột quê như {\sf Hồng} lại quyết định trở thành nhà Tâm lý học rồi quyết tâm làm điều đó. Thế mới hài. {\it Just another serious joke in the $\infty$ series of jokes}. Just let me inherit a small piece of your huge legacy, {\sc David Foster Wallace}. But I won't suicide though. Not this time. Not yet, {\sc David Foster Wallace}.
\end{quote}
...
\begin{itemize}
    ...
    Với bản dịch tiếng Việt:
    \item \cite{Stout_outsmart_sociopath_VN}. {\sc Martha Stout}. {\it Outsmarting the Sociopath Next Door: How To Protect Yourself Against A Ruthless Manipulator -- Trong Bộ Lông Cừu: Nhận Diện Bản Chất, Vạch Trần Cạm Bẫy \& Bảo Vệ Bản Thân Trước Những Kẻ Thao Túng Tâm Lý}.
\end{itemize}
...
\begin{quote}
    {\sf Hồng [23; Master 2 student]}: Tại sao tôi ngu như bò thế? Cái thằng xảo quyệt này là 1 kẻ ngược đãi, bạo hành tinh thần vợ mà tôi lại đi ngưỡng mộ nó như 1 mẫu hình đàn ông lý tưởng. Tôi luôn {\it cảm giác} có gì đó rất sai ở thằng này. Mà chả thể biết là gì. Đúng là nó hay quá, tài quá. Cái tài xảo quyệt của thằng thao túng tâm lý này bằng cách nào đó vượt qua rào cản nhận thức \& cơ chế phòng vệ tâm lý của tôi hoàn toàn.
    
    {\sf Nhân [23]}: Mày hạng tiểu nhân mà dám lừa tao tới mức tao coi mày là 1 bậc quân tử để rồi phải trầm cảm tới mức nặng vầy. Đ.M. thằng chó. Fuck fuck fuck.
\end{quote}
...
{\it Why triangle? What is so wrong with triangle? -- Tại sao lại là tam giác? Có cái quái gì sai trái với tam giác à?} Muốn bắt nạt hay, bắt nạt đẳng cấp thì phải có chiến thuật, mà có chiến thuật thì 1 trận bắt nạt cũng có thể được xem như 1 trận túc cầu, mà mô hình cơ bản nhất của cách di chuyển bóng giữa các cầu thủ chính là 1 hình tam giác, chứ không phải đường thẳng (straight line). Bởi nếu 3 đứa đứng thẳng hàng, thì 2 đứa đứng ngoài cùng chuyền nhau kiểu gì? Phải đá bóng bổng cho qua đầu cầu thủ đứng giữa hoặc chọt lọt khe hán cầu thủ đứng giữa à? Như đồng đội của {\sf Aoashi} giận cậu ta về cách di chuyển ngu học trên sân bóng, đó là do cậu ta không hiểu rằng tam giác chính là mô hình cơ bản nhất để di chuyển bóng là thế. Bắt nạt cũng vậy. Nào, cùng xem 1 kịch bản bắt nạt điển hình giữa 3 senpai với {\sf Hồng [23; Mathematics Master 2 student]}:

\begin{quote}
    {\sf Nhân [23]}: Đ.M. mày thằng lồn. Bộ mày không thể câm cái mõm toxic của mày 1 giây nào được à? Bộ lời lẽ toxic là Oxygen của mày à? Học ngu mà thích bắt nạt trí tuệ đàn em.
    
    {\sf Hồng [25]}: Sai. Vì học ngu, học dốt nên mới thích bắt nạt trí tuệ người khác. Nguyên lý về bản chất con người cũng giống nguyên lý sink-source của Vật Lý: Thiếu gì lấy đó. Thiếu thông minh, nhưng không chịu tự thân cày để bản thân mình tiến bộ, thì sẽ có xu hướng bắt nạt, chà đạp người khác để cảm thấy trí thông minh tương đối của mình được nâng cao hơn. Đơn giản. Physics! ``Science, bitches'' (từ 1 câu thoại trong series phim {\it Breaking Bad}).
\end{quote}
...
\begin{dinhnghia}[Định nghĩa toán học của kẻ tiểu nhân, kẻ khốn nạn]
    Kẻ tiểu nhân, kẻ khốn nạn là cá thể dùng toán tử triệt tiêu, rồi sử dụng toán tử nghịch đảo để biến những điều tốt đẹp thành những điều xấu, xuất phát từ trong tâm của kẻ đó, để hại những người tốt, đặc biệt là những kẻ quân tử.
    \begin{equation*}
        \mbox{Coward} = \mbox{de-operator master}:\mbox{positivities}\mapsto\mbox{negativity}.
    \end{equation*}
\end{dinhnghia}
Tương phản lại, ta cũng có định nghĩa của người quân tử, hoặc bậc thánh nhân theo câu chữ của {\sc Thu Giang--Nguyễn Duy Cần} trong các tác phẩm của ông, đặc biệt là trong quyển {\it Cái Dũng Của Bậc Thánh Nhân}:

\begin{dinhnghia}[Định nghĩa toán học của người quân tử, bậc thánh nhân]
    Người quân tử, bậc thánh nhân là cá thể có thể đảo ngược lại tác hại của toán tử triệt tiêu:
    \begin{equation*}
        \mbox{noble man} = \mbox{de-operator inverter}:\mbox{negativity}\mapsto\mbox{positivities}.
    \end{equation*}
\end{dinhnghia}
...
\section{Design Principles of Series: Some Topics in Elementary STEM \& Beyond -- Thiết Kế Chuỗi Tài Liệu \& Sách: 1 Số Chủ Đề STEM Sơ Cấp \& Hơn Thế Nữa}
...
\textbf{\textsf{Resources -- Tài nguyên.}}
\begin{enumerate}
    \item \cite{Binh_Toan_6_tap_1}. {\sc Vũ Hữu Bình}. {\it Nâng Cao \& Phát Triển Toán 6. Tập 1}.
    
    \item \cite{Binh_Toan_6_tap_2}. {\sc Vũ Hữu Bình}. {\it Nâng Cao \& Phát Triển Toán 6. Tập 2}.
    
    \item \cite{Binh_boi_duong_Toan_6_tap_1}. {\sc Vũ Hữu Bình, Đặng Văn Quân, Bùi Văn Tuyên}. {\it Bồi Dưỡng Toán 6. Tập 1}.
    
    \item \cite{Binh_boi_duong_Toan_6_tap_2}. {\sc Vũ Hữu Bình, Nguyễn Thị Quỳnh Anh, Phan Thanh Hồng, Bùi Văn Tuyên, Đặng Văn Tuyến, Nguyễn Thị Thanh Xuân}. {\it Bồi Dưỡng Toán 6. Tập 2}.
    
    \item \cite{PI_thich_toan}. {\sc Tạp Chí PI - Hội Toán Học Việt Nam}. {\it Để Các Em Thích Toán}
    
    \item \cite{TLCT_THCS_Toan_6_so_hoc}. {\sc Vũ Hữu Bình, Nguyễn Tam Sơn}. {\it Tài Liệu Chuyên Toán THCS Toán 6. Tập 1: Số Học}.
    
    \item \cite{TLCT_THCS_Toan_6_hinh_hoc}. {\sc Vũ Hữu Bình, Đàm Hiếu Chiến}. {\it Tài Liệu Chuyên Toán THCS Toán 6. Tập 2: Hình Học}.
    
    \item \cite{SGK_Toan_6_CD_tap_1}. {\sc Đỗ Đức Thái, Đỗ Tiến Đạt, Nguyễn Sơn Hà, Nguyễn Thị Phương Loan, Phạm Sỹ Nam, Phạm Đức Quang}. {\it Toán 6 Tập 1. Cánh Diều}.
    
    \item \cite{SGK_Toan_6_CD_tap_2}. {\sc Đỗ Đức Thái, Đỗ Tiến Đạt, Nguyễn Sơn Hà, Nguyễn Thị Phương Loan, Phạm Sỹ Nam, Phạm Đức Quang}. {\it Toán 6 Tập 2. Cánh Diều}.
    
    \item \cite{SBT_Toan_6_CD_tap_1}. {\sc Đỗ Đức Thái}. {\it Bài Tập Toán 6 Tập 1. Cánh Diều}.
    
    \item \cite{SBT_Toan_6_CD_tap_2}. {\sc Đỗ Đức Thái}. {\it Bài Tập Toán 6 Tập 2. Cánh Diều}.
    
    \item \cite{Trong_Toan_6}. {\sc Đặng Đức Trọng, Nguyễn Đức Tấn, Phạm Lê Quốc Thắng, Nguyễn Phúc Trường, Cao Hoàng Lợi}. {\it Bồi Dưỡng Năng Lực Tự Học Toán 6}
    
    \item \cite{Tuyen_Toan_6}. {\sc Bùi Văn Tuyên}. {\it Bài Tập Nâng Cao \& 1 Số Chuyên Đề Toán 6}.
\end{enumerate}
...
\textbf{\textsf{Resources -- Tài nguyên.}}
\begin{enumerate}
    \item \cite{Binh_Toan_7_tap_1}. Vũ Hữu Bình. {\it Nâng Cao \& Phát Triển Toán 7. Tập 1}.
    
    \item \cite{Binh_Toan_7_tap_2}. Vũ Hữu Bình. {\it Nâng Cao \& Phát Triển Toán 7. Tập 2}.
    ...
    \item \cite{Binh_boi_duong_Toan_7_tap_1}. Vũ Hữu Bình, Nguyễn Xuân Bình, Đàm Hiếu Chiến, Phan Thanh Hồng, Nguyễn Thị Thanh Xuân. {\it Bồi Dưỡng Toán 7 Tập 1}.
    
    \item \cite{Binh_boi_duong_Toan_7_tap_2}. Vũ Hữu Bình, Nguyễn Xuân Bình, Đàm Hiếu Chiến. {\it Bồi Dưỡng Toán 7 Tập 2}.
    ...
    \item \cite{SGK_Toan_7_CD_tap_1}. Đỗ Đức Thái, Đỗ Tiến Đạt, Nguyễn Sơn Hà, Nguyễn Thị Phương Loan, Phạm Sỹ Nam, Phạm Đức Quang. {\it Toán 7 Tập 1. Cánh Diều}.
    
    \item \cite{SGK_Toan_7_CD_tap_2}. Đỗ Đức Thái, Đỗ Tiến Đạt, Nguyễn Sơn Hà, Nguyễn Thị Phương Loan, Phạm Sỹ Nam, Phạm Đức Quang. {\it Toán 7 Tập 2. Cánh Diều}.
    
    \item \cite{Trong_Toan_7}. Đặng Đức Trọng, Nguyễn Đức Tấn, Phạm Lê Quốc Thắng, Nguyễn Phúc Trường, Cao Hoàng Lợi, Nguyễn Thị Kiều Anh. {\it Bồi Dưỡng Năng Lực Tự Học Toán 7}.
    
    \item \cite{Tuyen_Toan_7}. Bùi Văn Tuyên. {\it Bài Tập Nâng Cao \& 1 Số Chuyên Đề Toán 7}.
\end{enumerate}
...
\textbf{\textsf{Resources -- Tài nguyên.}}
\begin{enumerate}
    \item \cite{Binh_Toan_8_tap_1}. Vũ Hữu Bình. {\it Nâng Cao \& Phát Triển Toán 8. Tập 1}.
    
    \item \cite{Binh_Toan_8_tap_2}. Vũ Hữu Bình. {\it Nâng Cao \& Phát Triển Toán 8. Tập 2}.
    ...
    \item \cite{Binh_boi_duong_Toan_8_tap_1}. Vũ Hữu Bình, Nguyễn Xuân Bình, Phan Thanh Hồng, Phạm Thị Bạch Ngọc, Nguyễn Thị Thanh Xuân. {\it Bồi Dưỡng Toán 8 Tập 1}.
    
    \item \cite{Binh_boi_duong_Toan_8_tap_2}. Vũ Hữu Bình, Đàm Hiếu Chiến, Nguyễn Bá Đang, Phạm Thị Bạch Ngọc. {\it Bồi Dưỡng Toán 8 Tập 2}.
    
    \item \cite{TLCT_THCS_Toan_8_dai_so}. Vũ Hữu Bình, Trần Hữu Nam, Phạm Thị Bạch Ngọc, Nguyễn Tam Sơn. {\it Tài Liệu Chuyên Toán THCS Toán 8. Tập 1: Đại Số}.
    
    \item \cite{TLCT_THCS_Toan_8_hinh_hoc}. Vũ Hữu Bình, Văn Như Cương, Nguyễn Ngọc Đạm, Nguyễn Bá Đang, Trương Công Thành. {\it Tài Liệu Chuyên Toán THCS Toán 8. Tập 2: Hình Học}.
    
    \item \cite{SGK_Toan_8_tap_1}. Phan Đức Chính, Tôn Thân, Vũ Hữu Bình, Trần Đình Châu, Ngô Hữu Dũng, Phạm Gia Đức, Nguyễn Duy
    Thuận. {\it Toán 8 Tập 1}.
    
    \item \cite{SGK_Toan_8_tap_2}. Phan Đức Chính, Tôn Thân, Nguyễn Huy Đoan, Lê Văn Hồng, Trương Công Thành, Nguyễn Hữu Thảo. {\it Toán 8 Tập 2}.
    
    \item \cite{SGK_Toan_8_CD_tap_1}. Đỗ Đức Thái, Lê Tuấn Anh, Đỗ Tiến Đạt, Nguyễn Sơn Hà, Nguyễn Thị Phương Loan, Phạm Sỹ Nam, Phạm Đức Quang. {\it Toán 8 Cánh Diều Tập 1}.
    
    \item \cite{SGK_Toan_8_CD_tap_2}. Đỗ Đức Thái, Lê Tuấn Anh, Đỗ Tiến Đạt, Nguyễn Sơn Hà, Nguyễn Thị Phương Loan, Phạm Sỹ Nam, Phạm Đức Quang. {\it Toán 8 Cánh Diều Tập 2}.
    
    \item \cite{Tuyen_Toan_8_old,Tuyen_Toan_8}. Bùi Văn Tuyên. {\it Bài Tập Nâng Cao \& 1 Số Chuyên Đề Toán 8}.
\end{enumerate}
...
\textbf{\textsf{Resources -- Tài nguyên.}}
\begin{enumerate}
    \item \cite{Binh_Toan_9_tap_1}. Vũ Hữu Bình. {\it Nâng Cao \& Phát Triển Toán 9. Tập 1}.
    
    \item \cite{Binh_Toan_9_tap_2}. Vũ Hữu Bình. {\it Nâng Cao \& Phát Triển Toán 9. Tập 2}.
    
    \item \cite{Binh_boi_duong_Toan_9_tap_1}. Vũ Hữu Bình, Nguyễn Xuân Bình, Phạm Thị Bạch Ngọc. {\it Bồi Dưỡng Toán 9. Tập 1}.
    
    \item \cite{Binh_boi_duong_Toan_9_tap_2}. Vũ Hữu Bình, Nguyễn Xuân Bình, Phạm Thị Bạch Ngọc. {\it Bồi Dưỡng Toán 9. Tập 2.}
    
    \item \cite{TLCT_THCS_Toan_9_dai_so}. Vũ Hữu Bình, Phạm Thị Bạch Ngọc, Đàm Văn Nhỉ. {\it Tài Liệu Chuyên Toán THCS Toán 9. Tập 1: Đại Số}.
    
    \item \cite{TLCT_THCS_Toan_9_hinh_hoc}. Vũ Hữu Bình, Nguyễn Ngọc Đạm, Nguyễn Bá Đang, Lê Quốc Hán, Hồ Quang Vinh. {\it Tài Liệu Chuyên Toán THCS Toán 9. Tập 2: Hình Học}.
    
    \item \cite{Dung_Can_Anh_bdt_8_9}. Nguyễn Văn Dũng, Võ Quốc Bá Cẩn, Trần Quốc Anh. {\it Phương Pháp Giải Toán Bất Đẳng Thức \& Cực Trị Dành Cho Học Sinh 8, 9}.
    
    \item \cite{Tuyen_Toan_9_old}. Bùi Văn Tuyên. {\it Bài Tập Nâng Cao \& 1 Số Chuyên Đề Toán 9}.
...
\begin{enumerate}
    ...
    \begin{quote}
        {\sf Hồng [29--; Mathematics \& Computer Science lecturer]}: Khá trùng hợp, bài toán giải tam giác mà tôi tổng quát lại xuất hiện trong bài giảng \& bài tập thực hành của môn {\it Introduction to Artificial Intelligence -- Nhập Môn Trí Tuệ Nhân Tạo} cho sinh viên ngành Công Nghệ mà tôi đứng lớp Thực hành vào từ tháng 6--8, học kỳ Hè 2025.
    \end{quote}
...
\begin{enumerate}
    ...
    \item \cite{Hung_nang_cao_phat_trien_Toan_11_tap_1}. Trần Quang Hùng, Lê Thị Việt Anh, Phạm Việt Hải, Khiếu Thị Hương, Tạ Công Sơn, Nguyễn Xuân Thọ, Ninh Văn Thu, Phạm Đình Tùng. {\it Nâng Cao \& Phát Triển Toán 11 Tập 1}.
    
    \item \cite{Hung_nang_cao_phat_trien_Toan_11_tap_2}. Trần Quang Hùng, Lê Thị Việt Anh, Phạm Việt Hải, Khiếu Thị Hương, Tạ Công Sơn, Nguyễn Xuân Thọ, Ninh Văn Thu, Phạm Đình Tùng. {\it Nâng Cao \& Phát Triển Toán 11 Tập 2}.
    
    \item \cite{Liem_Thang2020}. Nguyễn Xuân Liêm, Đặng Hùng Thắng. {\it Bài Tập Nâng Cao \& 1 Số Chuyên Đề Đại Số \& Giải Tích 11}.
    
    \item \cite{Tan2017}. Trần Văn Tấn. {\it Bài Tập Nâng Cao \& Một Số Chuyên Đề Hình Học 11}.
    
    \item \cite{TLCT_hinh_hoc_11}. Đoàn Quỳnh, Phạm Khắc Ban, Văn Như Cương, Nguyễn Đăng Phất, Lê Bá Khánh Trình. {\it Tài Liệu Chuyên Toán Hình Học 11}.	
\end{enumerate}
...
\textbf{\textsf{Resources -- Tài nguyên.}}
\begin{enumerate}
    \item \cite{Kiselev_hhkg}. A. P. Kiselev. {\it Hình Học Không Gian}.
    ...
    \item \cite{TLCT_giai_tich_12}. Đoàn Quỳnh (CB), Trần Nam Dũng, Hà Huy Khoái, Đặng Hùng Thắng, Nguyễn Trọng Tuấn. {\it Tài Liệu Chuyên Toán Giải Tích 12}.
    
    \item \cite{TLCT_hinh_hoc_12}. Đoàn Quỳnh (CB), Hạ Vũ Anh, Phạm Khắc Ban, Văn Như Cương, Vũ Đình Hòa. {\it Tài Liệu Chuyên Toán Hình Học 12}.
\end{enumerate}
...
\subsubsection{Elementary Chemistry Grade 6}
Hóa Học Sơ Cấp lớp 6 khá đơn giản, chỉ nêu lên 1 số khái niệm cơ bản, chưa có công thức hóa học, \& các phương trình hóa học. Nên chúng tôi chỉ sử dụng 1 file duy nhất để tóm tắt kiến thức Hóa Học Sơ Cấp lớp 6, thậm chí không cần cheatsheet:
\begin{itemize}
...
\begin{itemize}\sf\small
	...
	\item {\it book-smart} [a] {\tt/}\textipa{`bUk smA:t}{\tt/} having a lot of academic knowledge learned from books \& studying, but not necessarily knowing much about people \& living in the real world.
	...
	\item {\it street-smart} [a] {\tt/}\textipa{`stri:t smA:t}{\tt/} (also {\it streetwise}) having the knowledge \& experience that is needed to deal with the difficulties \& dangers of life in a big city.
	...
	\item {\it street smarts} [a] {\tt/}\textipa{`stri:t smA:ts}{\tt/} [plural] the knowledge \& experience that is needed to deal with the difficulties \& dangers of life in a big city.
...
\begin{quote}
    ...
    Khoan nghĩ tới tiền lương cái đã, tập trung vào chất lượng của viết lách, cũng như tập trung vào số lượng cũng không phải là 1 ý tồi, bởi vì STEM nâng cao thật sự rất rộng, nếu không học rộng thì mỗi bài viết cho 1 chuyên ngành có thể sẽ rất hạn hẹp về mặt nội dung.
	
	At the end of the day, no matter how hard I struggle with these advanced knowledge, it feels so good when you are useful to others or at least you feel or partially aware that you are useful. All those pains finally start to fade.
...
\section{Advanced STEM {\it\&} Beyond -- STEM Nâng Cao \& Xa Hơn Thế Nữa}

\begin{quote}
    {\sf Hồng [29--; Mathematics \& Computer Science lecturer]}: Tạm quên cái việc phải gấp rút lấy bằng PhD về Toán cái. Tập trung vào câu hỏi làm sao để viết 1 chuỗi tài liệu về STEM nâng cao đủ nghệ? Yeah. That is the right question. {\it How to write an aesthetic series of Advanced STEM \& Beyond?}
\end{quote}
Gần như mọi tài liệu chúng tôi viết, mà chúng tôi nghĩ là có thể công khai, được chứa đầy đủ trong trang web của {\it Advanced STEM \& Beyond}: \url{https://nqbh.github.io/advanced_STEM/}.

%------------------------------------------------------------------------------%

\subsection{Information Technology Fundamentals -- Nền Tảng Công Nghệ Thông Tin}
Latest version:
\begin{itemize}
    \item NQBH. {\it Lecture Note: Information Technology Fundamentals -- Bài Giảng: Nền Tảng Công Nghệ Thông Tin}.
    ...
    \item NQBH. {\it Đề thi giữa kỳ môn Nền Tảng Công Nghệ Thông Tin II Hè 202}.
    ...
    \item NQBH. {\it Lời giải đề thi giữa kỳ môn Nền Tảng Công Nghệ Thông Tin II Hè 2025}.
...
\textbf{\textsf{Resources -- Tài nguyên.}}
\begin{enumerate}
    \item \cite{Graham_Knuth_Patashnik1994}. {\sc Ronald L. Graham, Donald Erwin Knuth, Oren Patashnik}. {\it Concrete Mathematics: A Foundation for Computer Science}. 2e.
    
    {\sf Comment.} 1 quyển sách của nhà Khoa học máy tính huyền thoại {\sc Donald Erwin Knuth}. Tôi{\tt/}tui muốn dạy quyển này cho các sinh viên cả ngành Toán--Tin, lẫn ngày Công Nghệ Thông Tin.
    
    \item \cite{White_Ray2021}. {\sc Ryan T. White, Archana Tikayat Ray}. {\it Practical Discrete Mathematics: Discover Math Principles That Fuel Algorithms for Computer Science \& Machine Learning with Python}. (tạm dịch: {\it Toán Rời Rạc Thực Tế: Khám Phá Các Nguyên Lý Toán Học Thúc Đẩy Thuật Toán Cho Khoa Học Máy Tính \& Học Máy với Python}).
\end{enumerate}
...
\textbf{\textsf{Resources -- Tài nguyên.}}
\begin{enumerate}
    \item \cite{Lieb_Loss2001}. {\sc Elliott H. Lieb, Michael Loss}. {\it Analysis}.
    
    \item \cite{Quoc_Long_Dat_Nam_VMC}. {\sc Văn Phú Quốc, Trương Hồ Thiên Long, Đỗ Hữu  Đạt, Đinh Ngọc Nam}. {\it Bài Tập Giải Tích Olympic Toán Sinh Viên \& Học Sinh}.
...
\begin{enumerate}
    ...
    \item \cite{Kallenberg2021}. {\sc Olav Kallenberg}. {\it Probability Theory \& Stochastic Modelling}.
    ...
    \item \cite{Varadhan2001}. {\sc S. R. S. Varadhan}. {\it Probability Theory}. Courant Lecture Notes in Mathematics.
\end{enumerate}
...
\subsection{Mathematical Optimization -- Toán Tối Ưu}
\textbf{\textsf{Resources -- Tài nguyên.}}
\begin{enumerate}
...
\subsection{Combinatorics {\it\&} Graph Theory -- Tổ Hợp {\it\&} Lý Thuyết Đồ Thị}
\textbf{\textsf{Resources -- Tài nguyên.}}
\begin{enumerate}
...
\textbf{\textsf{Resources -- Tài nguyên.}}
\begin{enumerate}
    \item \cite{Binh_Thanh_Thuc_Minh_math_DS}. {\sc Nguyễn Thanh Bình, Đinh Ngọc Thanh, Nguyễn Đình  Thúc, Nguyễn Đăng Minh}. {\it Cơ Sở Toán Cho Khoa Học Dữ Liệu}.
    
    \item \cite{Grus2019}. {\sc Joel Grus}. {\it Data Science from Scratch: First Principles with Python}. 2e.
    
    \item \cite{McKinney2022}. {\sc Wes McKinney}. {\it Python for Data Analysis: Data Wrangling with pandas, NumPy, \& Jupyter}.
    
    \begin{note}
        {\sc Wes McKinney} is the creator of {\tt pandas}.
    \end{note} 
\end{enumerate}
...
\begin{example}[{\sc P. Diddy} \& The Aluminati?]
...
\begin{quote}
    {\sf Nhân [29--]:} I know. I know. We shouldn't share any future plan to anyone. Because when we share, that plan hardy becomes true. Haters always find ways to destroy good things from good people.
\end{quote}
...
\begin{principle}[Principle of positivity non-conservation -- Nguyên lý về sự không bảo toàn của tính tích cực]
    ...
    {\sf[en]$\to$[vi]} Nếu có sự mất mát lớn về mặt tâm lý tích cực mà một người đã cố gắng tạo ra \& lan truyền sang những người khác xung quanh người đó, thì ít nhất cũng có một kẻ thao túng tâm lý đóng vai trò là Hố đen tâm lý với mục đích phá hủy mọi sự tích cực \& tạo ra sự tiêu cực \& sau đó lan truyền sang những người xung quanh nạn nhân bị thao túng tâm lý đó.
\end{principle}
