...
count()        find()         isalnum()      isdigit()      isprintable()  join()         maketrans()    replace()      rpartition()   splitlines()   title()                      
		...
		\begin{itemize}
			\item {\sf5.1. Introduction to pandas Data Structures.}
		...
		\begin{itemize}
			...
			\item {\sf9.2. Plotting with pandas \& seaborn.}
		...
		\begin{itemize}
			\item {\sf12.1. Interfacing Between pandas \& Model Code.}
