...
{\sf[198 Amazon ratings][39 Goodreads ratings]}
...
\begin{itemize}
	...
	\item {\sf Preface to 2e.} \fbox{A key ingredient in learning mathematics is problem solving.} This is strength, \& no doubt reason for longevity of Prof. {\sc Spiegel}'s advanced calculus. His collection of solved \& unsolved problems remains a part of this 2e.
...
\begin{itemize}
	...
	\begin{itemize}
		...
		1st part of book is dedicated to fundamental results \& key examples of recurrences \& their properties. Also present geometry of linear recurrences in complex plane in some detail. Some recent research has lead to unexpected developments within combinatorics, number theory, integer sequences, \& random number generation.
		
		2nd part of book present 123 olympiad training problems with full solutions \& some appendices. These relate to linear recurrences of 1st, 2nd, \& higher orders, classical sequences, homographic recurrences, systems of recurrences, complex recurrent sequences, \& recurrence sequences in combinatorics.
		\item {\sf Audience.} this book will be useful for researchers \& scholars interested in recent advances in field of recurrences, postgraduate students in college or university \& their instructors, or advanced high school students.
		...
		\begin{enumerate}
			...
			\item Chap. 7 contains 123 olympiad training problems involving recurrent sequences, solved in detail in Chap. 8. Many problems are original \& concern linear recurrence sequences of 1st, 2nd, \& higher orders, some classical sequences, homographic sequences, systems of sequences, complex recurrence sequences, \& recursions in combinatorics.
			\item {\sf Prerequisites.} Intention: make book as self-contained as possible, so have included many defs together with examples.Chaps. 1, 2, \& 5 only require good understanding of college algebra, complex numbers, analysis, \& basic combinatorics. For Chaps. 3, 4, \& 6, prerequisites include number theory, linear algebra, \& complex analysis.
			\item {\sf How to Use Book.} Book presents recurrent sequences in connection with a wide range of topics \& is illustrated with numerous examples \& diagrams.
			
			Introductory chap \& some of properties of 1st- \& 2nd-order linear recurrences (which include classical number sequences) are elementary \& can be understood by high school students.
			
			More advanced topics e.g. homographic recurrences, generating functions, higher-order recurrent sequences, or systems of recurrent sequences require concepts usually covered in college or undergraduate courses.
			
			Have also included many original \& recent results on arithmetic \& trigonometric properties of classical sequences, new application of Cauchy's integral formula in study of polynomial coefficients, or complex recurrent patterns applied in pseudo-random number generation, which explore reader to state of art in field.
			
			Collection of problems with full solutions illustrates wide range of topics where recurrent sequences can be found \& represents an ideal material for preparing students for Olympiad.
			
			Book also includes 177 refs \& an index which will help readers to further investigate key notions \& concepts.
		\end{enumerate}
	\end{itemize}
	\item {\sf1. Introduction to Recurrence Relations.} In this chap, present fundamental concepts \& motivating examples of recurrent sequences, \& show connections of recurrence relations to mathematical modeling, algebra, combinatorics, \& analysis. There re numerous sources presenting classical theory (see, e.g., [41, 62, 128]).
	
	\item {\sf2. Basic Recurrent Sequences.}
	\item {\sf3. Arithmetic \& Trigonometric Properties of Some Classical Recurrent Sequences.}
	\item {\sf4. Generating Functions.}
	\item {\sf5. More on 2nd-Order Linear Recurrent Sequences.}
	\item {\sf6. Higher Order Linear Recurrent Sequences.}
	\item {\sf7. Recurrences in Olympiad Training.}
	\item {\sf8. Solutions to Proposed Problems.}
...
\begin{itemize}
	...
	With regard to examinations for a course based on this text, would recommend either an open-book, open-notes examination with problems similar to exercises given in text (but perhaps shorter, with no unusual trickery involved), or else a take-home examination that involves problems comparable to more intricate exercises in text. Subject matter is too vast to force students to memorize defs \& theorems, so would not recommend a closed-book examination, or an examination based on regurgitating extracts from book. (Indeed, in own examinations gave a supplemental sheet listing key defs \& theorems which were relevant to examination problems.) Making examinations similar to homework assigned in course will also help motivate students to work through \& understand their homework problems as thoroughly as possible (as opposed to, say, using flash cards or other such devices to memorize material), which is good preparation not only for examinations but for doing mathematics in general.
	
	Some of material in this textbook is somewhat peripheral to main theme \& may be omitted for reasons of time constraints. E.g., as set theory is not as fundamental to analysis as are number systems, chaps on set theory (Chaps. 3, 8) can be covered more quickly \& with substantially less rigor, or be given as reading assignments. Appendices on logic \& decimal system are intended as optional or supplemental reading \& would probably not be covered in main course lectures; appendix on logic is particularly suitable for reading concurrently with 1st few chaps. Also, Chap. 5 (on Fourier series) is not needed elsewhere in text \& can be omitted.
	
	For reasons of length, this textbook has been split into 2 volumes. 1st volume is slightly longer, but can be covered in about 30 lectures if peripheral material is omitted or abridged. 2nd volume refers at times to 1st, but can also be taught to students who have had a 1st course in analysis from other sources. It also takes about 30 lectures to cover.
	\item {\sf1. Introduction.}
	\begin{itemize}
		\item {\sf1.1. What Is Analysis?} This text is an honors-level undergraduate introduction to {\it real analysis}: analysis of real numbers, sequences \& series of real numbers, \& real-valued functions. This is related to, but is distinct from, {\it complex analysis}, which concerns analysis of complex numbers \& complex functions, {\it harmonic analysis}, which concerns analysis of harmonics (waves) e.g. sine waves, \& how they synthesize other functions via Fourier transform, {\it functional analysis}, which focuses much more heavily on functions (\& how they form things like vector spaces), \& so forth. {\it Analysis} is rigorous study of such objects, with a focus on trying to pin down precisely \& accurately qualitative \& quantitative behavior of these objects. Real analysis is theoretical foundation which underlies {\it calculus}, which is collection of computational algorithms which one uses to manipulate functions.
...
\begin{itemize}
	...
	\item {\sf1. What is Numerical Analysis?}
	\item {\sf2. Collocation Polynomial.}
	\item {\sf3. Finite Differences.}
	\item {\sf4. Factorial Polynomials.}
	\item {\sf5. Summation.}
	\item {\sf6. Newton Formula.}
	\item {\sf7. Operators \& Collocation Polynomials.}
	\item {\sf8. Unequally Spaced Arguments.}
	\item {\sf9. Splines.}
	\item {\sf10. Osculating Polynomials.}
	\item {\sf11. Taylor Polynomial.}
	\item {\sf12. Interpolation.}
	\item {\sf13. Numerical Differentiation.}
	\item {\sf14. Numerical Integration.}
	\item {\sf15. Gaussian Integration.}
	\item {\sf16. Singular Integrals.}
	\item {\sf17. Sums \& Series.}
	\item {\sf18. Difference Equations.}
	\item {\sf19. Differential Equations.}
	\item {\sf20. Differential Problems of Higher Order.}
	\item {\sf21. Least-Squares Polynomial Approximation.}
	\item {\sf22. Min-Max Polynomial Approximation.}
	\item {\sf23. Approximation by Rational Functions.}
	\item {\sf24. Trigonometric Approximation.}
	\item {\sf25. Nonlinear Algebra.}
	\item {\sf26. Linear Systems.}
	\item {\sf27. Linear Programming.}
	\item {\sf28. Overdetermined Systems.}
	\item {\sf29. Boundary Value Problems.}
	\item {\sf30. Monte Carlo Methods.}
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\end{equation*}
		p. 11 +++
		\item {\sf1.2. Examples of parameter estimation problems.}
	\end{itemize}
\end{itemize}
