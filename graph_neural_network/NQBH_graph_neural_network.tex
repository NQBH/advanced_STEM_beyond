...
schedule_mwkr = solver_mwkr(instance)
    ...
    \begin{itemize}
        ...
        \end{itemize}
        \item {\sf3.3. Relational Graph Neural Networks.}
    \end{itemize}
    \item {\sf4. Reinforcement Learning vs. Imitation Learning.}
    \item {\sf5. Literature Review \& Problem Formulation.}

    II. CONTRIBUTION \& RESULTS.
    \item {\sf6. Introducing {\tt JobShopLib}.}
