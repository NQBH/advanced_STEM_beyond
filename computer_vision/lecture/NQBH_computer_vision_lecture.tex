...
\title{Lecture Note: Computer Vision {\it\&} Image Processing\\Bài Giảng: Thị Giác Máy Tính {\it\&} Xử Lý Ảnh Kỹ Thuật Số}
...
Latest version:
\begin{itemize}
    \item {\it Lecture Note: Computer Vision \& Digital Image Processing -- Bài Giảng: Thị Giác Máy Tính \& Xử Lý Ảnh Kỹ Thuật Số}.
...
\chapter{Introduction To Digital Image Processing -- Nhập Môn Xử Lý Ảnh Số}
\minitoc

%------------------------------------------------------------------------------%

\chapter{Color Transformation -- Phép Biến Đổi Màu Sắc}
\minitoc

%------------------------------------------------------------------------------%

\chapter{Geometric Transformation on Images -- Phép Biến Đổi Hình Học Trên Ảnh}
\minitoc

%------------------------------------------------------------------------------%

\chapter{Smoothing Images -- Làm Trơn Ảnh}
\minitoc

%------------------------------------------------------------------------------%

\chapter{Edge Detection -- Phát Hiện Biên Cạnh}
\minitoc

%------------------------------------------------------------------------------%

\chapter{Image Segmentation -- Phân Đoạn Ảnh}
\minitoc

%------------------------------------------------------------------------------%

\chapter{Image Processing Based on Set Operations -- Xử Lý Ảnh Dựa Trên Phép Toán Tập Hợp}
\minitoc

%------------------------------------------------------------------------------%

\chapter{Image Classification -- Phân Lớp Ảnh}
