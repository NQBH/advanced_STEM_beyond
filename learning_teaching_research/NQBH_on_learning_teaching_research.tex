...
\begin{center}
	\thispagestyle{empty}
	\vspace*{\fill}\it
	Dedicated to disadvantaged kids who love to learn about this world, love to discover this wonderful life,\\\vspace{2mm} children \& young adults who are sensitive, \& vulnerable children in broken families.\\\vspace{2cm}
	Gửi tặng những đứa trẻ có hoàn cảnh khó khăn nhưng thích học về thế giới này, thích khám phá cuộc sống kỳ diệu này,\\\vspace{2mm} những đứa trẻ \& người trẻ nhạy cảm cao, dễ tổn thương trong các gia đình tan vỡ.
	\vspace*{\fill}
\end{center}
\clearpage
\tableofcontents
