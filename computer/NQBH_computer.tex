...
\begin{itemize}
	...
	\item \href{https://docs.anaconda.com/navigator/}{Anaconda Navigator} - a desktip application built on conda, with options to launch other development applications from your managed environments.
\end{itemize}
