...
from sklearn.metrics import accuracy_score
    ...
    \begin{itemize}
        ...
        \begin{enumerate}
            \item 1st, want to install {\tt gensim} library to use Word2Vec. This time, use version 3.8.0 for compatibility reasons: \verb|!pip install -qI gensim==3.8.0|
        ...
        \end{enumerate}
        \item {\sf Building a move RecSys.}
    \end{itemize}
