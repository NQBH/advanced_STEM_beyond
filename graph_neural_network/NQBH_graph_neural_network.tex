...
DG.add_edges_from([('A', 'B'), ('A', 'C'), ('B', 'D'), ('B', 'E'), ('C', 'F'), ('C', 'G')])
        ...
        -- 1 thuộc tính quan trọng khác của đồ thị là các cạnh có trọng số hay không có trọng số. Trong một đồ thị có trọng số, mỗi cạnh đều có trọng số hoặc chi phí liên quan. Các trọng số này có thể biểu thị nhiều yếu tố khác nhau, ví dụ: khoảng cách, thời gian di chuyển hoặc chi phí.
...
labels = nx.get_edge_attributes(WG, "weight")
        ...
        -- Kết nối đồ thị là một khái niệm cơ bản trong lý thuyết đồ thị có liên quan chặt chẽ đến cấu trúc \& chức năng của đồ thị.
        ...
        -- Trong 1 đồ thị liên thông, luôn có một đường đi giữa hai đỉnh bất kỳ trong đồ thị. Về mặt hình thức, một đồ thị $G$ được coi là liên thông nếu và chỉ nếu (iff) với mọi cặp đỉnh $u,v$ trong $G$, tồn tại một đường đi từ $u$ đến $v$. Ngược lại, một đồ thị được coi là không liên thông nếu nó không liên thông, tức là có ít nhất 2 đỉnh không được nối với nhau bằng một đường đi.
...
print(f"Is graph 2 connected? {nx.is_connected(G2)}")
        ...
        -- {\sf Các loại đồ thị.} Ngoài các loại đồ thị thường dùng, còn có một số loại đồ thị đặc biệt với các thuộc tính \& đặc điểm riêng:
        \begin{enumerate}
            \item Cây là đồ thị liên thông, vô hướng và không có chu trình. Vì chỉ có 1 đường đi giữa 2 nút bất kỳ trong cây, nên cây là một trường hợp đặc biệt của đồ thị. Cây thường được sử dụng để mô hình hóa các cấu trúc phân cấp, ví dụ: cây phả hệ, cấu trúc tổ chức hoặc cây phân loại.
            \item Cây có gốc là cây trong đó 1 nút được chỉ định là gốc, \& tất cả các đỉnh khác được kết nối với nó bằng một đường đi duy nhất. Cây có gốc thường được sử dụng trong CS để biểu diễn các cấu trúc dữ liệu phân cấp, ví dụ: hệ thống tệp hoặc cấu trúc của tài liệu XML.
            \item Đồ thị có hướng phi chu trình (DAG) là đồ thị có hướng không có chu trình, tức là các cạnh chỉ có thể được duyệt theo một hướng cụ thể, \& không có vòng lặp hoặc chu trình. DAG thường được sử dụng để mô hình hóa sự phụ thuộc giữa các tác vụ hoặc sự kiện -- ví dụ: trong quản lý dự án hoặc tính toán đường dẫn tới hạn của một công việc.
            ...
            \item Đồ thị đầy đủ là đồ thị trong đó mỗi cặp đỉnh được nối bởi một cạnh. Đồ thị đầy đủ thường được sử dụng trong tổ hợp để mô hình hóa các bài toán liên quan đến tất cả các kết nối từng cặp có thể có, \& trong mạng máy tính để mô hình hóa các mạng được kết nối đầy đủ.
        \end{enumerate}
        Bây giờ chúng ta đã xem xét các loại đồ thị thiết yếu, khám phá một số đối tượng đồ thị quan trọng nhất. Việc hiểu các khái niệm này sẽ giúp phân tích \& thao tác đồ thị một cách hiệu quả.
        ...
        -- {\sf Khám phá các khái niệm về đồ thị.} Trong phần này, khám phá một số khái niệm thiết yếu trong lý thuyết đồ thị, bao gồm các đối tượng đồ thị (ví dụ: bậc \& lân cận), các phép đo đồ thị (ví dụ: độ trung tâm \& mật độ), \& biểu diễn ma trận kề.
        \begin{itemize}
...
print(f"deg^+(A) = {DG.out_degree['A']}")
            ...
            -- Trong lý thuyết đồ thị, đường đi là một chuỗi các cạnh nối 2 nút (hoặc nhiều hơn) trong một đồ thị. Độ dài của đường đi là số cạnh được đi qua dọc theo đường đi. Có nhiều loại đường đi khác nhau, nhưng có 2 loại đặc biệt quan trọng:
            \begin{enumerate}
                \item Đường đi đơn là đường đi không đi qua bất kỳ nút nào quá một lần, ngoại trừ đỉnh đầu \& đỉnh cuối.
            ...
            \end{enumerate}
            Bậc \& đường đi có thể được sử dụng để xác định tầm quan trọng của một nút trong mạng. Thước đo này được gọi là độ trung tâm.
            ...
            \begin{enumerate}
                ...
                \item {\bf Độ tập trung gần} đo lường mức độ gần của một nút với tất cả các nút khác trong đồ thị. Nó tương ứng với độ dài trung bình của đường đi ngắn nhất giữa nút mục tiêu \& tất cả các nút khác trong đồ thị. 1 nút có độ tập trung gần cao có thể nhanh chóng tiếp cận tất cả các đỉnh khác trong mạng.
                \item {\bf Độ tập trung giữa} đo lường số lần một nút nằm trên đường đi ngắn nhất giữa các cặp nút khác trong đồ thị. 1 nút có tính trung tâm cao đóng vai trò như một nút thắt cổ chai hoặc cầu nối giữa các phần khác nhau của đồ thị.
            \end{enumerate}
...
print(f"Betweenness centrality = {nx.betweenness_centrality(G)}")
            ...
            -- Đồ thị dày đặc có mật độ gần bằng 1, trong khi đồ thị thưa có mật độ gần bằng 0. Không có quy tắc nghiêm ngặt nào về việc thế nào là đồ thị dày đặc hay thưa thớt, nhưng nhìn chung, một đồ thị được coi là dày đặc nếu mật độ của nó > 0,5 \& thưa nếu mật độ của nó < 0,1. Phép đo này liên quan trực tiếp đến một vấn đề cơ bản với đồ thị: cách biểu diễn ma trận kề.
...
edge_list = [(0, 1), (0, 2), (1, 3), (1, 4), (2, 5), (2, 6)]
        ...
        -- Trong Chương 3: Tạo Biểu diễn Nút với DeepWalk, khám phá kiến trúc DeepWalk \& 2 thành phần của nó: {\tt Word2Vec} \& bước ngẫu nhiên. Bắt đầu bằng cách tìm hiểu kiến trúc {\tt Word2Vec} \& sau đó triển khai nó bằng một thư viện chuyên dụng. Sau đó, đi sâu vào thuật toán DeepWalk \& triển khai bước ngẫu nhiên trên đồ thị.
    \end{itemize}
    ...
    -- Trong chương này, chúng ta sẽ tìm hiểu về kiến trúc DeepWalk \& 2 thành phần chính của nó: Word2Vec \& random walks. Giải thích cách thức hoạt động của kiến trúc Word2Vec, đặc biệt tập trung vào mô hình skip-gram. Triển khai mô hình này với thư viện {\tt gensim} phổ biến trên một ví dụ NLP để hiểu cách sử dụng.
    ...
    \begin{itemize}
        ...
        -- {\sf Giới thiệu Word2Vec.} Bước đầu tiên để hiểu thuật toán DeepWalk: hiểu thành phần chính của nó: Word2Vec. Word2Vec là một trong những kỹ thuật DL có ảnh hưởng nhất trong NLP. Được công bố vào năm 2013 bởi {\sc Tomas Mikolov} và cộng sự (Google) trong 2 bài báo khác nhau, kỹ thuật này đã đề xuất một kỹ thuật mới để dịch từ thành các vectơ (còn được gọi là {\sc nhúng}) bằng cách sử dụng các tập dữ liệu văn bản lớn. Các biểu diễn này sau đó có thể được sử dụng trong các tác vụ tiếp theo, ví dụ như phân loại cảm xúc. Đây cũng là một trong những ví dụ hiếm hoi về kiến trúc ML phổ biến và đã được cấp bằng sáng chế.
        ...
        \begin{itemize}
            ...
            -- {\sf CBOW so với skip-gram.} Một mô hình phải được huấn luyện trên một tác vụ giả định để tạo ra các vectơ này. Bản thân tác vụ không cần phải có ý nghĩa: mục tiêu duy nhất của nó là tạo ra các nhúng chất lượng cao. Trên thực tế, tác vụ này luôn liên quan đến việc dự đoán các từ trong một ngữ cảnh nhất định.
            ...
            \begin{itemize}
                \item {\bf Mô hình túi từ liên tục (CBOW).} Mô hình này được huấn luyện để dự đoán một từ trong ngữ cảnh xung quanh nó (các từ đứng trước \& sau từ mục tiêu). Thứ tự của các từ ngữ cảnh không quan trọng vì các nhúng của chúng được tổng hợp trong mô hình. Các tác giả tuyên bố thu được kết quả tốt hơn khi sử dụng 4 từ đứng trước \& sau từ được dự đoán.
                \item {\bf Mô hình bỏ qua liên tục.} Ở đây, chúng tôi đưa một từ duy nhất vào mô hình \& cố gắng dự đoán các từ xung quanh nó. Việc tăng phạm vi từ ngữ cảnh dẫn đến các nhúng tốt hơn nhưng cũng làm tăng thời gian huấn luyện.
            \end{itemize}
            ...
            -- Nhìn chung, mô hình CBOW được đánh giá là nhanh hơn khi huấn luyện, nhưng mô hình skip-gram lại chính xác hơn nhờ khả năng học các từ ít phổ biến. Chủ đề này vẫn đang được tranh luận trong cộng đồng NLP: một triển khai khác có thể khắc phục các vấn đề liên quan đến CBOW trong một số bối cảnh.
            ...
            -- {\sf Tạo skip-gram.} Trước mắt, hãy tập trung vào mô hình skip-gram vì đây là kiến trúc được DeepWalk sử dụng. Skip-gram được triển khai theo cặp từ với cấu trúc sau (từ đích, từ ngữ cảnh), trong đó {\sf từ đích} là đầu vào \& {\sf từ ngữ cảnh} là từ cần dự đoán. Số lượng skip-gram cho cùng một từ đích phụ thuộc vào một tham số gọi là {\sf kích thước ngữ cảnh}, như thể hiện trong {\sf Hình 3.2: Văn bản thành skip-gram}. Ý tưởng tương tự có thể được áp dụng cho một tập hợp văn bản thay vì một câu đơn lẻ.
...
print(skipgrams[0:2])
            ...
            -- Trong thực tế, hãy lưu trữ tất cả các từ ngữ cảnh cho cùng một từ mục tiêu trong một danh sách để tiết kiệm bộ nhớ. Xem cách thực hiện với ví dụ trên toàn bộ một đoạn văn. Trong ví dụ sau, hãy tạo skip-gram cho toàn bộ một đoạn văn được lưu trữ trong biến {\tt text}. Đặt biến \verb|CONTEXT_SIZE| thành 2, tức là xem xét 2 từ trước \& sau từ mục tiêu của chúng ta:
            \begin{enumerate}
                ...
                \item Tiếp theo, hãy tạo skip-gram nhờ vòng lặp {\tt for} đơn giản để xem xét mọi từ trong {\tt text}. Một danh sách hiểu biết tạo ra các từ ngữ cảnh, được lưu trữ trong danh sách {\tt skipgrams}:
                \begin{verbatim}
skipgrams = []
for i in range(CONTEXT_SIZE, len(text) - CONTEXT_SIZE):
    array = [text[j] for j in np.arange(i - CONTEXT_SIZE, i + CONTEXT_SIZE + 1) if j != i]
...
print(skipgrams[0:2])
            ...
            -- {\sf mô hình skip-gram.} Mục tiêu của Word2Vec: tạo ra các nhúng từ chất lượng cao. Để học các nhúng này, nhiệm vụ huấn luyện của mô hình skip-gram bao gồm dự đoán các từ ngữ cảnh chính xác dựa trên một từ mục tiêu.
            ...
            -- Tưởng tượng chúng ta có một chuỗi $N$ từ $w_1,w_2,\ldots,w_N$. Xác suất nhìn thấy từ $w_2$ cho từ $w_1$ được viết là $p(w_2|w_1)$. Mục tiêu: tối đa hóa tổng của mọi xác suất nhìn thấy một từ ngữ cảnh cho một từ đích trong toàn bộ văn bản:
            \begin{equation*}
                \frac{1}{N}\sum_{n=1}^N\sum_{-c\le j\le c,\ j\ne0} \log p(w_{n+j}|w_n),
            \end{equation*}
            ...
            \begin{remark}
                ...
                -- Tại sao chúng ta sử dụng xác suất logarit trong phương trình prev? Việc chuyển đổi xác suất thành xác suất logarit là một kỹ thuật phổ biến trong ML (\& CS nói chung) vì 2 lý do chính. Tích trở thành phép cộng (\& phép chia trở thành phép trừ). Phép nhân tốn kém về mặt tính toán hơn phép cộng, do đó, tính xác suất logarit nhanh hơn: $\log(ab) = \log a + \log b$. Cách máy tính lưu trữ những số rất nhỏ, ví dụ: {\tt3.14e-128} không hoàn toàn chính xác, không giống như logarit của cùng một số $-127.5$ trong trường hợp này. Những sai số nhỏ này có thể cộng lại \& làm sai lệch kết quả cuối cùng khi các sự kiện cực kỳ khó xảy ra. Nhìn chung, phép biến đổi đơn giản này cho phép chúng ta tăng tốc \& độ chính xác mà không làm thay đổi mục tiêu ban đầu.
            \end{remark}
            ...
            -- Các mô hình skip-gram cơ bản sử dụng hàm softmax để tính xác suất nhúng từ ngữ cảnh $h_c$ cho một từ mục tiêu nhúng $h_t$:
            \begin{equation*}
                p(w_c|w_t) = \frac{\exp(h_ch_t^\top)}{\sum_{i=1}^{|V| \exp(h_ih_t^\top)}},
            \end{equation*}
...
print(f"Length of vocabulary = {VOCAB_SIZE}")
            ...
            -- Bây giờ, với kích thước của vốn từ vựng, chúng ta cần định nghĩa thêm một tham số nữa: $N$, số chiều của vectơ từ. Thông thường, giá trị này được đặt trong khoảng từ 100 \ đến 1000. Trong ví dụ này, hãy đặt thành 10 vì kích thước tập dữ liệu của chúng ta có hạn.
            ...
            \begin{itemize}
                \item A {\it projection layer} với ma trận trọng số $W_{\rm embed}$, lấy một vectơ từ được mã hóa 1-hot làm đầu vào \& trả về nhúng từ $N$-dim tương ứng. Nó hoạt động như một bảng tra cứu đơn giản lưu trữ các nhúng có chiều được xác định trước.
                \item A {\it fully connected layer} với ma trận trọng số $W_{\rm output}$, lấy một nhúng từ làm đầu vào \& trả về logit $|V|$-dim. Một hàm softmax được áp dụng cho các dự đoán này để chuyển đổi logit thành xác suất.
            \end{itemize}

            \begin{remark}
                There is no activation function: {\tt Word2Vec} is a linear classifier that models a linear relationship between words.

                -- Không có hàm kích hoạt: {\tt Word2Vec} là một bộ phân loại tuyến tính mô hình hóa mối quan hệ tuyến tính giữa các từ.
            \end{remark}
            ...
            -- Gọi ${\bf x}$ là vectơ từ mã hóa 1-hot {\it input}. Nhúng từ tương ứng có thể được tính toán như một phép chiếu đơn giản $h = W_{\rm embed}^\top\cdot{\bf x}$. Sử dụng mô hình skip-gram, có thể viết lại xác suất trước đó như sau:
            \begin{equation*}
                p(w_c|w_t) \frac{\exp(W_{\rm output}\cdot h)}{\sum_{i=1}^{|V|} \exp(W_{\rm output(i)}\cdot h)}.
            \end{equation*}
            Mô hình Skip-gram đưa ra một vectơ $|V|$-dim, là xác suất có điều kiện của mọi từ trong từ vựng:
            \begin{equation*}
                word2vec(w_t) = \begin{bmatrix}
                    p(w_1|w_t)\\p(w_2|w_t)\\vdots\\p(w_{|V|}|w_t)
                \end{bmatrix}.
            ...
            \begin{enumerate}
                ...
                \item Có thể in một nhúng từ để xem kết quả của quá trình huấn luyện này trông như thế nào.

            \end{enumerate}
            Mặc dù phương pháp này hiệu quả với các từ vựng nhỏ, nhưng chi phí tính toán khi áp dụng hàm softmax đầy đủ cho hàng triệu từ (kích thước từ vựng) thường quá tốn kém. Đây là một yếu tố hạn chế trong việc phát triển các mô hình ngôn ngữ chính xác trong một thời gian dài. May mắn thay, các phương pháp khác đã được thiết kế để giải quyết vấn đề này.
            ...
            -- Word2Vec (\& DeepWalk) triển khai một trong những kỹ thuật này, được gọi là H-Softmax. Thay vì một softmax phẳng tính toán trực tiếp xác suất của từng từ, kỹ thuật này sử dụng cấu trúc cây nhị phân với các lá là các từ. Thú vị hơn nữa, có thể sử dụng cây Huffman, trong đó các từ ít phổ biến được lưu trữ ở các cấp độ sâu hơn so với các từ phổ biến. Trong hầu hết các trường hợp, điều này giúp tăng tốc đáng kể việc dự đoán từ lên gấp $\ge50$.
            ...
            -- H-Softmax có thể được kích hoạt trong {\tt gensim} bằng cách sử dụng {\tt hs = 1}. Đây là phần khó nhất của kiến trúc DeepWalk. Nhưng trước khi có thể triển khai nó, cần thêm một thành phần nữa: cách tạo dữ liệu huấn luyện.
        \end{itemize}
        ...
        -- {\sf DeepWalk \& random walks.} Được đề xuất vào năm 2014 bởi {\sc Perozzi} và cộng sự, DeepWalk nhanh chóng trở nên cực kỳ phổ biến trong giới nghiên cứu đồ thị. Lấy cảm hứng từ những tiến bộ gần đây trong NLP, nó luôn vượt trội hơn các phương pháp khác trên một số tập dữ liệu. Mặc dù các kiến trúc hiệu suất cao hơn đã được đề xuất kể từ đó, DeepWalk là một đường cơ sở đơn giản \& đáng tin cậy, có thể được triển khai nhanh chóng để giải quyết nhiều vấn đề.
        ...
        -- Tại sao các bước ngẫu nhiên lại quan trọng? Ngay cả khi các nút được chọn ngẫu nhiên, việc chúng thường xuất hiện cùng nhau theo một trình tự có nghĩa là: chúng gần nhau. Theo giả thuyết {\it network homophily}, các nốt gần nhau thì tương tự nhau. Điều này đặc biệt đúng trong các mạng xã hội, nơi mọi người kết nối với bạn bè \& gia đình.
...
print(random_walk(0, 10))
        ...
        -- Có thể thấy: một số nút nhất định, ví dụ: 0 \& 9, thường được tìm thấy cùng nhau. Xét đến việc đây là một đồ thị đồng dạng, tức là chúng tương tự nhau. Đây chính xác là loại mối quan hệ mà chúng ta đang cố gắng nắm bắt bằng DeepWalk. Bây giờ, chúng ta đã triển khai Word2Vec \& random walks riêng biệt, hãy kết hợp chúng để tạo ra DeepWalk.
        ...
        -- {\sf Triển khai DeepWalk.} Bây giờ, hãy hiểu rõ từng thành phần trong kiến trúc này, hãy sử dụng nó để giải quyết một bài toán ML. Tập dữ liệu chúng tôi sử dụng là Câu lạc bộ Karate của Zachary. Nó đơn giản biểu diễn các mối quan hệ trong một câu lạc bộ karate được {\sc Wayne W. Zachary} nghiên cứu vào những năm 1970. Đây là một dạng mạng xã hội, trong đó mỗi nút là một thành viên, \& các thành viên tương tác bên ngoài câu lạc bộ được kết nối.
...
from sklearn.manifold import TSNE
    ...
    \end{itemize}
    PART 2: FUNDAMENTALS.
    \item {\sf4. Improving Embeddings with Biased Random Walks in Node2Vec.}
    \item {\sf5. Including Node Features with Vailla Neural Networks.}
